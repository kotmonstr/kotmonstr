        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <div class="features_items"><!--features_items-->
                    ...
                    <?php if($modelWishList): ?>
                    <?php foreach ($modelWishList as $good): ?>
                            ...
                            <div class="product-image-wrapper">
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <li><a href="javascript:void(0);" onclick="AddToCompareList(<?= $good->goods->id  ?>)"><i class="fa fa-plus-square"></i>В список сравнений</a></li>
